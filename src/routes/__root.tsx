...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Diego Cardoso — Otorrinolaringologia Clínica & Cirúrgica | Torre Sulamel" },
      { name: "description", content: "Consultas atenciosas e humanizadas de ouvido, nariz e garganta, exames de videolaringoscopia e cirurgias na Várzea, Teresópolis." },
      { property: "og:title", content: "Dr. Diego Cardoso — Otorrinolaringologista" },
      { property: "og:description", content: "Respire com liberdade e viva sem limites com atendimento humanizado." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='#1e3a8a'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='white' font-family='sans-serif' font-weight='800' font-size='40'>DC</text></svg>" },
