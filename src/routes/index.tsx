...
${notes ? `*Observações / Sintomas:* ${notes}` : ""}`;
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 selection:bg-cyan-100 selection:text-cyan-950 pb-24 lg:pb-0">
      ...
      <a
        href="https://wa.me/5521964639999?text=Ol%C3%A1%21%20Vim%20pelo%20site%20do%20Dr.%20Diego%20Cardoso%20e%20gostaria%20de%20ver%20como%20funciona%20para%20fechar%20a%20compra%20dele%20com%20voc%C3%AA."
        target="_blank"
        rel="noreferrer"
